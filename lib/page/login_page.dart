...
class _LoginPageState extends State<LoginPage> {
  ...
  Future login(email, password) async {
    ...
    var response = await http.post(
        Uri.parse('https://yukbimbel.000webhostapp.com/api/login'),
        body: body);
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text('Login', style: TextStyle(fontSize: 35, fontWeight: FontWeight.w400),),
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      child: const Text('Daftar', style: TextStyle(color: Color(0xFF17a2b8)),),
                                    )
                                  ],
                                )
                              ]
