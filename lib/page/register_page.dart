            ...
            children: [
              Container(
                ...
                child: Column(
                  ...
                  children: const [
                    Text('Bimbel Paham App', style: TextStyle(fontSize: 25, fontWeight: FontWeight.bold, color: Colors.white),),
                  ],
                )
              ),
              ListView(
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          const Text('Register', style: TextStyle(fontSize: 35, fontWeight: FontWeight.w300),),
                              ...
                              children: [
                                SizedBox(
                                  ...
                                  style: ElevatedButton.styleFrom(
                                    ...
                                    onPressed: () {
                                    register(usernamedController.text, emailController.text, passwordController.text);
                                ...
                                Row(
                                  ...
                                  children: [
                                    ...
                                    InkWell(
                                      ...
                                      child: const Text('Login', style: TextStyle(color: Color(0xFF17a2b8)),),
                                    )
                                  ],
                                )
                              ]
