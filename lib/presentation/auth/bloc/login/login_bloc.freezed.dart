...
mixin _$LoginState {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(LoginResponse loginResponse) loaded,
  ...
  TResult? whenOrNull<TResult extends Object?>({
    ...
    TResult? Function(LoginResponse loginResponse)? loaded,
...
abstract class _Loaded implements LoginState {
  const factory _Loaded(final LoginResponse loginResponse) = _$LoadedImpl;
